            ...
            <ul id="revolutionul" style="display:none;">            
                    ...
                    <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="assets/img/sliders/revolution/thumbs/thumb2.jpg">
                        ...
                        <div class="caption lft slide_subtitle slide_item_left"
                             ...
                             data-start="2000"
                             data-easing="easeOutExpo">
                             Sistema de control de flotas inteligente
                        </div>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="300" data-delay="9400" data-thumb="assets/img/sliders/revolution/thumbs/thumb2.jpg">                        
                        ...
                        <div class="caption lfl slide_desc slide_item_left"
                             ...
                             data-start="4500"
                             data-easing="easeOutExpo">
                             En un un formulario fácil de administrar
                        </div>                        
    ...
    <div class="container">
        ...
        <div class="row-fluid quote-v1">
            <div class="span9 quote-v1-inner">
                <span>ESTAMOS GENERANDO LA REVOLUCIÓN EN EL CONSUMO DE COMBUSTIBLE</span>
            </div>
            <div class="span3 quote-v1-inner text-right">
                <a class="btn-transparent" href="http://www.insepet.com/" target="_blank"><i class="icon-rocket margin-right-10"></i>Visita nuestra empresa</a>
        ...
        <div class="row-fluid recent-work margin-bottom-40">
            <div class="span3">
                <h2><a href="portfolio.html">Trabajos recientes</a></h2>
                <p>Todo el tiempo trabajamos para mejorar la forma como se gestiona el combustible y generamos valor agregado al negocio.</p>
            </div>
            <div class="span9">
                <ul class="bxslider">
                    <li>
                    ...
                    <li>
                        ...
                        <a class="bxslider-block" href="#">
                            ...
                            <b>Sistema de control de ventas.</b>
                        </a>
                    </li>
                    <li>
                        <em>
        ...
        <div class="row-fluid margin-bottom-40">
            <div class="span3">
                <h2><a href="#">Nuestros clientes</a></h2>
