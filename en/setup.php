...
<!--                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <label class="control-label"></label>
                                    <div class="controls">
                                        <button type="submit" class="btn blue"><i class="icon-ok"></i> Receipt setup</button>                                        
                                    </div>
				</div>
			</form>
...
<!--                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <label class="control-label"></label>
                                    <div class="controls">
                                        <button type="submit" class="btn blue"><i class="icon-ok"></i> Fuel types</button>                                       
                                    </div>
				</div>
			</form>
			<!-- END FORM-->  								
			...
			<!-- BEGIN FORM-->
                        ...
                        <form action="urestrict.php" class="form-horizontal">                              
                            <div class="control-group">
                                <label class="control-label"></label>
                                    <div class="controls">                                   
                                        <button type="submit" class="btn red">Vehicle update</button>
                                    </div>
				</div>
			</form>
                        <form action="vehicle.php" class="form-horizontal">                              
                            <div class="control-group">
                                <label class="control-label"></label>
                                    <div class="controls">                                   
                                        <button type="submit" class="btn red">Add vehicle to an existing account</button>
                                    </div>
				</div>
			</form>
			<!-- END FORM-->  								
