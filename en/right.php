...
<body>	
    ...
    <div class="row-fluid breadcrumbs margin-bottom-40">
        <div class="container">
            <div class="span4">
                <h1>Create user for control system</h1>
            </div>
            <div class="span8">
    ...
    <div class="container min-hight">
        ...
        <div class="row-fluid">
            ...
            <div class="span9 blog-item margin-bottom-40">
                ...
                <h2><a href="#">User creation successful</a></h2>                
                <blockquote>
                    <p>Now you can use the app</p>                    
                </blockquote>                                                
                 <p><?php 
                ...
                <div class="blog-talks margin-bottom-30">
                    ...
                    <div class="tab-style-1">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab-1" data-toggle="tab">Simple</a></li>
                            <li><a href="#tab-2" data-toggle="tab">All the data</a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane row-fluid fade in active" id="tab-1">
                                <p class="margin-bottom-10">Easy change.</p>
                                <p><a href="index.php" class="read-more">Read more</a></p>
                            </div>
                            <div class="tab-pane fade" id="tab-2">
                                <p>All the information that you need</p>
                            </div>
                        </div>
                    </div>
                </div>                            
