...
<head>
	<meta charset="utf-8" />
	<title>GRP700X - Fleet | Registro Inicial</title>
...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
			...
			<h3 class="form-title">Cuenta nueva</h3>
			...
			<div class="form-actions">								  
                                <input input type="submit" name="enviar" value="Crear"  class="btn blue pull-right"  />
			</div>
